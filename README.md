...
If you fork this repo, be sure to change all URL references to https://github.com/tkischka/hackerschool_skillmaptest to your forked repo's URL. Otherwise you won't see your changes.
